...
class BoundingBoxManagerSingleton
{
	...
	std::vector<BoundingBoxClass*> m_lBox; //list of Boxes
...
public:
	...
	*/
	...
	/*
	CalculateCollision
		Calculates the collision among all the Boxes in the list
	*/
	void CalculateCollision(void);
	void SetBoxVisibility(bool visible, String a_sInstanceName);
